...
// in terms of VIOLATIONS OF CLEAN ARCHITECTURE since PreferredLocationConnector (use case) only references DataFetchControl (controller)
...
public class PreferredLocationConnector{
    ...
    public static ArrayList<Integer> withinPreferredLocation(int id, double locationRange) {
        ...
        if (lastId > 0) {
            ...
            return ids;
        } else { // case when there is no profile in the database
