...
public class RegCheckerTest {
    ...
    public void testRegChecker(){
        ...
        PicUploader uploader = new PicUploader(f,b);
        ...
        uploader.received = true;
        RegChecker checkerAllGood = new RegChecker(platformInfo, email, pw, name, age ,postcode, uploader);
        assertTrue(checkerAllGood.pass);

        // Implicitly test checkIfMissing:
        // test when one of inputs is missing
        String emptyEmail = "";
        RegChecker checkerMiss = new RegChecker(platformInfo, emptyEmail, pw, name, age ,postcode, uploader);
        ...
        uploader.received = false;
        RegChecker checkerNoPic = new RegChecker(platformInfo, email, pw, name, age ,postcode, uploader);
        ...
        RegChecker checkerNonValidEmail = new RegChecker(platformInfo, nonValidEmail, pw, name, age ,postcode, uploader);
        ...
        RegChecker checkerCodeNoSpace = new RegChecker(platformInfo, email, pw, name, age ,postcodeNoSpace, uploader);
        ...
        RegChecker checkerCodeNotCanadian = new RegChecker(platformInfo, email, pw, name, age ,postcodeNotCanadian, uploader);
        ...
        RegChecker checkerAgeRangeFail = new RegChecker(platformInfo, email, pw, name, ageRangeFail ,postcode, uploader);
        ...
        String ageNotNum = "a";
        RegChecker checkerAgeNotNum = new RegChecker(platformInfo, email, pw, name, ageNotNum ,postcode, uploader);
